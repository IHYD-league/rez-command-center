...
// ===================== PARENT: TODAY =====================
function ParentToday({ todaysTasks, compByTask, availableToday, earnedToday, pendingStars, starBank, handoff, users, mode, setMode, priorities, setPriority, clearPriority, giftStars, user, activities, streaks, setDetailId, onEasy }) {
  ...
  return (
    <div className="px-4 pt-4">
      ...
      {pending.map((t) => <MiniRow key={t.id} task={t} comp={compByTask[t.id]} tone="amber" mode={mode} priorities={priorities} users={users} activities={activities} onOpenDetail={setDetailId} />)}
      ...
      {done.map((t) => <MiniRow key={t.id} task={t} comp={compByTask[t.id]} tone="emerald" users={users} mode={mode} priorities={priorities} activities={activities} onOpenDetail={setDetailId} />)}
...
function MiniRow({ task, comp, tone, users, mode, priorities, setPriority, clearPriority, activities, onOpenDetail }) {
